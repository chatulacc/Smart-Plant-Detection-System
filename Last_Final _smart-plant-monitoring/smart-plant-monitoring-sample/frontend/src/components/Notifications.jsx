...
import {
  Bell, AlertCircle, AlertTriangle, Info, CheckCircle, Trash2, CheckCheck, Leaf, Cpu
} from 'lucide-react';
          ...
          >
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              {[
                ...
                { label: 'AI Prediction', type: 'ai',  cls: 'sev-ai' },
