  ...
  useEffect(() => {
    const fetchHistory = async () => {
      try {
        ...
        // If the Firebase structure stores historical readings under a `readings` key,
        // use that object. Otherwise, treat the top-level as either a flat reading or
        // as a keyed collection of historical entries.
        let source = fbData;
        if (fbData && fbData.readings && typeof fbData.readings === 'object') {
          source = fbData.readings;
        }
